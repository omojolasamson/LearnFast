...
{{--  
            <li class="nav-item col-8">
               ...
               {{-- <a class="nav-link btn btn-light  mx-2" href="#"
                ...
                data-toggle="popover" title="Try LearnFast for Business"
                data-placement="bottom",
                data-trigger="focus"
                data-content="Get your team access to LearnFast’s top 2,500 courses anytime,
                 anywhere.">Learnfast for Business</a> --}}
                <a class="nav-link btn btn-light  mx-2" href="/instructing">Become an Instructor</a>
                   ...
                   <div class="col-md-4">
                        <div class="media">
                             ...
                             <div class="media-body">
                               ...
                               Learn on your terms with lifetime course access and the LearnFast mobile app
                             </div>
                           </div>
                    </div>
...
<div class="row" style="font-size: 12px;">
      <div class="col pl-5">
          ...
          {{--  <img src="/images/logo-coral.svg" width="100px" >  --}}
           ...
           <span>Copyright © 2020 Tech365.</span>
      </div>
      <div class="col">
